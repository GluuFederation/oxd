...
public enum ErrorResponseCode {
    ...
    INVALID_REFRESH_TOKEN(401, "invalid_refresh_token", "refresh_token is invalid. The provided refresh is not valid or is not longer valid."),
    ...
    INVALID_AUTHORIZATION_CODE_BAD_CODE(400, "invalid_authorization_code", "Authorization code is invalid. Please use the code from authorization URL."),
