...
#define OXDInfoBeforeFile "C:\Users\ABC\Desktop\oxd.txt"
#define OXDOutputDir "F:\"
...
InfoBeforeFile={#OXDInfoBeforeFile}
OutputDir={#OXDOutputDir}
...
begin
  ...
  InstallAsServiceCheckBox.Parent := MainPage.Surface;
  InstallAsServiceCheckBox.Top := 100;
  InstallAsServiceCheckBox.Left := 85;
  InstallAsServiceCheckBox.Width := 380;
