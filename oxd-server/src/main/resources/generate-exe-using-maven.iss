...
#define OXDInstructionFile "..\..\..\doc\license.txt"
...
Source: "{#OXDTargetDir}\oxd-server-distribution\license\*"; DestDir: "{app}\license"; Flags: ignoreversion recursesubdirs createallsubdirs
