...
install -m 644 oxd-https-extension/target/oxd-https-extension-3.1.6.Final.jar %{buildroot}/opt/oxd-https-extension/lib/
...
%changelog
* Mon Mar 07 2016 Adrian Alves <adrian@gluu.org> - 3.1.6-1
- Release 3.1.6
